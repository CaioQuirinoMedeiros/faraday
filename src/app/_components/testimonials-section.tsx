...
import { StarsBackground } from './starts-background'

export function TestimonialsSection() {
  return (
    <section
      id='depoimentos'
      className='relative flex flex-col items-center justify-center py-20 bg-background'
    >
      <StarsBackground
        starDensity={0.00015}
      ...
      <div className='max-w-3xl flex flex-col items-center'>
        <div className='flex flex-col gap-3.5 items-center mb-8'>
          ...
          <h2 className='text-4xl font-bold text-center text-white'>
            O que os <span className='text-primary'>alunos dizem</span>
          </h2>
        </div>
